...
return (
  ...
  <>
    ...
    <div className="container-fluid">
      ...
      <a className="navbar-brand text-white" href="/">eKART</a>
      ...
      <li className="nav-item ">
        ...
        <NavLink className="nav-link active text-white " aria-current="page"to="/login">Login</NavLink>
  ...
  <div className="text-center mt-2"><button className="btn btn-primary mt-2">REGISTER</button></div>
